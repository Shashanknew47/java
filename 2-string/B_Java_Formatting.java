...
class B_Java_Formatting {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%+d \n",a);   // + sing will show the sign of the number too.
        System.out.printf("%10.2f is a decimal_number \n",decimal_number); //  "10" here means total places it will  take is 10 and "2" means decimal point will be 2.
